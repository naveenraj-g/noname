...
import { createModelSettings } from "../../serveractions/admin-server-actions";
...
export const AdminAddModelSettingsModal = () => {
  ...
  const isModalOpen = isOpen && modalType === "addModelSettings";
  ...
  const { execute } = useServerAction(createModelSettings, {
    onSuccess() {
      toast.success("Model Settings created.", {
        richColors: true,
      });
    },
    onError(args) {
