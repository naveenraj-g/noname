...
class PractitionerIdentifier(Base):
    ...
    practitioner_id = Column(String, ForeignKey("practitioner.id"), nullable=False, index=True)
...
class PractitionerQualification(Base):
    ...
    code_text = Column(String, nullable=True)  # e.g., "MD", "PhD", "Board Certified in Cardiology"
