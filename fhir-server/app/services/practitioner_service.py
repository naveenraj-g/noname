...
class PractitionerService:
    ...
    async def update_practitioner(self, practitioner_id: int, practitioner_data: dict) -> Practitioner:
        practitioner_data.pop("id", None)
        practitioner = Practitioner.model_validate(practitioner_data)
        return await self.repository.update(practitioner_id, practitioner)
